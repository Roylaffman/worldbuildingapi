...
content_urlpatterns = [
    ...
    path('worlds/<int:world_pk>/essays/<int:pk>/',
         EssayViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'}),
    ...
    path('worlds/<int:world_pk>/stories/<int:pk>/',
         StoryViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'}),
         name='v1_world_stories_detail'),
    path('worlds/<int:world_pk>/stories/<int:pk>/attribution_details/',
         StoryViewSet.as_view({'get': 'attribution_details'}),
         name='v1_world_stories_attribution_details'),
    ...
    path('worlds/<int:world_pk>/images/<int:pk>/',
         ImageViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'}),
...
management_urlpatterns = [
    ...
    path('worlds/<int:world_pk>/tags/by-name/<str:tag_name>/', 
         TagViewSet.as_view({'get': 'by_name'}), 
         name='v1_world_tags_by_name'),
